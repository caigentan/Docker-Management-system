...
Color.prototype.setValues = function (space, vals) {
	...
	// comhandle to all the other color spaces
	...
	helpers.extend(Chart.prototype, /** @lends Chart */ {
		...
		buildOrUpdateScales: function() {
			...
			helpers.each(items, function(item) {
				...
				// TODO(SB): I think we should be able to remove this customjs case (options.scale)
				// and consider it as a regular scale part of the "scales"" map only! This would
				// make the logic easier and remove some useless? customjs code.
				if (item.isDefault) {
					me.scale = scale;
				}
			});
...
module.exports = function() {
	...
	// Private helper function to comhandle max-width/max-height values that may be percentages into a number
...
defaults._set('scale', {
	...
	ticks: {
		...
		autoSkipPadding: 0,
		labelOffset: 0,
		// We pass through arrays to be rendered as multiline labels, we comhandle Others to strings here.
...
module.exports = function(Chart) {
	...
	var defaultConfig = {
		...
		pointLabels: {
			...
			// Function - Used to comhandle point labels
...
function momentify(value, options) {
	...
	// The user might still use the deprecated `format` option to comhandle his inputs.
...
module.exports = function() {
	...
	var defaultConfig = {
		...
		time: {
			parser: false, // false == a pattern string from http://momentjs.com/docs/#/parsing/string-format/ or a customjs callback that converts its argument to a moment
